...
-- Liên kết: training_result_details (PENDING) → training_results (id=9) → training_plans (id=3, APPROVED)
...
INSERT INTO training_result_details (training_result_id, training_plan_detail_id, employee_id, training_sample_id, planned_date, actual_date, status, is_pass, note, created_by, delete_flag, created_at, updated_at)
VALUES
(9, (SELECT id FROM training_plan_details WHERE batch_id = 'dashboard-mock-1'), 1, 1, @today, NULL, 'PENDING', NULL, 'Dashboard mock pending result - chờ huấn luyện', 'system', 0, NOW(), NOW()),
(9, (SELECT id FROM training_plan_details WHERE batch_id = 'dashboard-mock-2'), 2, 2, @today, NULL, 'PENDING', NULL, 'Dashboard mock pending result - chờ huấn luyện', 'system', 0, NOW(), NOW()),
(9, (SELECT id FROM training_plan_details WHERE batch_id = 'dashboard-mock-3'), 3, 3, @today, NULL, 'PENDING', NULL, 'Dashboard mock pending result - chờ huấn luyện', 'system', 0, NOW(), NOW()),
(9, (SELECT id FROM training_plan_details WHERE batch_id = 'dashboard-mock-4'), 4, 4, @today, NULL, 'PENDING', NULL, 'Dashboard mock pending result - chờ huấn luyện', 'system', 0, NOW(), NOW()),
(9, (SELECT id FROM training_plan_details WHERE batch_id = 'dashboard-mock-5'), 5, 5, @today, NULL, 'PENDING', NULL, 'Dashboard mock pending result - chờ huấn luyện', 'system', 0, NOW(), NOW()),
(9, (SELECT id FROM training_plan_details WHERE batch_id = 'dashboard-mock-6'), 6, 6, @today, NULL, 'PENDING', NULL, 'Dashboard mock pending result - chờ huấn luyện', 'system', 0, NOW(), NOW()),
(9, (SELECT id FROM training_plan_details WHERE batch_id = 'dashboard-mock-7'), 1, 1, @today, NULL, 'PENDING', NULL, 'Dashboard mock pending result - chờ huấn luyện', 'system', 0, NOW(), NOW()),
(9, (SELECT id FROM training_plan_details WHERE batch_id = 'dashboard-mock-8'), 2, 2, @today, NULL, 'PENDING', NULL, 'Dashboard mock pending result - chờ huấn luyện', 'system', 0, NOW(), NOW()),
(9, (SELECT id FROM training_plan_details WHERE batch_id = 'dashboard-mock-9'), 3, 3, @today, NULL, 'PENDING', NULL, 'Dashboard mock pending result - chờ huấn luyện', 'system', 0, NOW(), NOW()),
(9, (SELECT id FROM training_plan_details WHERE batch_id = 'dashboard-mock-10'), 4, 4, @today, NULL, 'PENDING', NULL, 'Dashboard mock pending result - chờ huấn luyện', 'system', 0, NOW(), NOW()),
(9, (SELECT id FROM training_plan_details WHERE batch_id = 'dashboard-mock-11'), 5, 5, @today, NULL, 'PENDING', NULL, 'Dashboard mock pending result - chờ huấn luyện', 'system', 0, NOW(), NOW()),
(9, (SELECT id FROM training_plan_details WHERE batch_id = 'dashboard-mock-12'), 6, 6, @today, NULL, 'PENDING', NULL, 'Dashboard mock pending result - chờ huấn luyện', 'system', 0, NOW(), NOW());

-- F. 2 dòng PENDING result cho các plan details có sẵn từ V6 (IDs 13, 14 - NV003 & NV004 thuộc Plan 3, T3)
INSERT INTO training_result_details (training_result_id, training_plan_detail_id, employee_id, training_sample_id, planned_date, actual_date, status, is_pass, note, created_by, delete_flag, created_at, updated_at)
VALUES
(9, 13, 3, 2, '2026-03-11', NULL, 'PENDING', NULL, 'NV003 - chờ huấn luyện T3', 'tl_tien01', 0, NOW(), NOW()),
...
INSERT INTO training_plans (id, form_code, title, start_date, end_date, team_id, line_id, status, current_version, note, min_training_per_day, max_training_per_day, created_by)
VALUES
(100, 'TP-PH-2026-004', 'Kế hoạch HLV T4/2026 - Tổ Phay Ca Ngày', '2026-04-01', '2026-04-30', 2, 2, 'APPROVED', 1, 'Tháng 4 đã duyệt, đang thực hiện.', 1, 3, 'tl_phay01'),
(101, 'TP-HA-2026-002', 'Kế hoạch HLV T2/2026 - Tổ Hàn & Nhiệt',  '2026-02-03', '2026-02-28', 3, 3, 'APPROVED', 1, 'Tổ Hàn T2 đã duyệt.', 1, 3, 'tl_hanlap01'),
(102, 'TP-HA-2026-004', 'Kế hoạch HLV T4/2026 - Tổ Hàn & Nhiệt',  '2026-04-01', '2026-04-30', 3, 3, 'APPROVED', 1, 'Tổ Hàn T4 đã duyệt, toàn bộ pending.', 1, 3, 'tl_hanlap01'),
(103, 'TP-B-2026-004',  'Kế hoạch HLV T4/2026 - Tổ Lắp Ráp Bơm',  '2026-04-01', '2026-04-30', 4, 5, 'APPROVED', 1, 'T4 đã duyệt, đang thực hiện.', 1, 3, 'tl_laprap01'),
(104, 'TP-DC-2026-004', 'Kế hoạch HLV T4/2026 - Tổ Động Cơ',       '2026-04-01', '2026-04-30', 5, 4, 'APPROVED', 1, 'T4 đã duyệt, chờ MG duyệt kết quả.', 1, 2, 'tl_dongco01'),
(105, 'TP-KCS-2026-004','Kế hoạch HLV T4/2026 - Tổ KCS',            '2026-04-01', '2026-04-30', 6, 5, 'APPROVED', 1, 'T4 KCS đã duyệt.', 1, 2, 'tl_kcs01');
...
-- Result 100 (Phay T4): 5 batch_ids → 5 result details (2 APPROVED + 3 PENDING)
INSERT INTO training_result_details (training_result_id, training_plan_detail_id, employee_id, training_sample_id, planned_date, actual_date, status, is_pass, note, created_by, delete_flag, created_at, updated_at)
VALUES
-- NV007 batch → liên kết dòng DONE
(100, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-ph4-nv007' AND status = 'DONE'), 7, 7, '2026-04-03', '2026-04-03', 'APPROVED', TRUE, 'NV007 đạt T4', 'tl_phay01', 0, NOW(), NOW()),
-- NV008 batch → liên kết dòng DONE
(100, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-ph4-nv008' AND status = 'DONE'), 8, 8, '2026-04-04', '2026-04-04', 'APPROVED', TRUE, 'NV008 đạt T4', 'tl_phay01', 0, NOW(), NOW()),
-- NV009 batch → liên kết dòng PENDING (ngày lên lịch lại)
(100, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-ph4-nv009' AND status = 'PENDING'), 9, 9, '2026-04-14', NULL, 'PENDING', NULL, 'NV009 chờ HLV ngày mới', 'tl_phay01', 0, NOW(), NOW()),
-- NV010 batch → liên kết dòng PENDING
(100, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-ph4-nv010' AND status = 'PENDING'), 10, 10, '2026-04-08', NULL, 'PENDING', NULL, 'NV010 chờ HLV', 'tl_phay01', 0, NOW(), NOW()),
-- NV012 batch → liên kết dòng PENDING (ngày lên lịch lại)
(100, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-ph4-nv012' AND status = 'PENDING'), 12, 8, '2026-04-09', NULL, 'PENDING', NULL, 'NV012 chờ HLV ngày mới', 'tl_phay01', 0, NOW(), NOW());

-- Result 101 (Hàn T2): 4 batch_ids → 4 result details (2 APPROVED + 2 PENDING)
INSERT INTO training_result_details (training_result_id, training_plan_detail_id, employee_id, training_sample_id, planned_date, actual_date, status, is_pass, note, created_by, delete_flag, created_at, updated_at)
VALUES
(101, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-ha2-nv013' AND status = 'DONE'), 13, 10, '2026-02-04', '2026-02-04', 'APPROVED', TRUE,  'NV013 đạt T2 Hàn', 'tl_hanlap01', 0, NOW(), NOW()),
(101, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-ha2-nv014' AND status = 'DONE'), 14, 11, '2026-02-05', '2026-02-05', 'APPROVED', FALSE, 'NV014 trượt T2 Hàn', 'tl_hanlap01', 0, NOW(), NOW()),
(101, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-ha2-nv015' AND status = 'PENDING'), 15, 12, '2026-02-17', NULL, 'PENDING', NULL, 'NV015 chờ HLV ngày mới', 'tl_hanlap01', 0, NOW(), NOW()),
(101, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-ha2-nv016' AND status = 'PENDING'), 16, 10, '2026-02-11', NULL, 'PENDING', NULL, 'NV016 chờ HLV', 'tl_hanlap01', 0, NOW(), NOW());

-- Result 102 (Hàn T4): 4 batch_ids → 4 result details (tất cả PENDING)
INSERT INTO training_result_details (training_result_id, training_plan_detail_id, employee_id, training_sample_id, planned_date, actual_date, status, is_pass, note, created_by, delete_flag, created_at, updated_at)
VALUES
(102, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-ha4-nv013' AND status = 'PENDING'), 13, 10, '2026-04-10', NULL, 'PENDING', NULL, 'NV013 chờ HLV ngày mới', 'tl_hanlap01', 0, NOW(), NOW()),
(102, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-ha4-nv014' AND status = 'PENDING'), 14, 11, '2026-04-04', NULL, 'PENDING', NULL, 'NV014 chờ HLV', 'tl_hanlap01', 0, NOW(), NOW()),
(102, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-ha4-nv015' AND status = 'PENDING'), 15, 12, '2026-04-14', NULL, 'PENDING', NULL, 'NV015 chờ HLV ngày mới', 'tl_hanlap01', 0, NOW(), NOW()),
(102, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-ha4-nv016' AND status = 'PENDING'), 16, 10, '2026-04-08', NULL, 'PENDING', NULL, 'NV016 chờ HLV', 'tl_hanlap01', 0, NOW(), NOW());

-- Result 103 (Lắp Bơm T4): 4 batch_ids → 4 result details (1 APPROVED + 3 PENDING)
INSERT INTO training_result_details (training_result_id, training_plan_detail_id, employee_id, training_sample_id, planned_date, actual_date, status, is_pass, note, created_by, delete_flag, created_at, updated_at)
VALUES
...
INSERT INTO training_result_details (training_result_id, training_plan_detail_id, employee_id, training_sample_id, planned_date, actual_date, status, is_pass, note, created_by, delete_flag, created_at, updated_at)
VALUES
(104, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-dc4-nv022' AND status = 'DONE'), 22, 18, '2026-04-03', '2026-04-03', 'APPROVED', TRUE, 'NV022 đạt T4', 'tl_dongco01', 0, NOW(), NOW()),
...
INSERT INTO training_result_details (training_result_id, training_plan_detail_id, employee_id, training_sample_id, planned_date, actual_date, status, is_pass, note, created_by, delete_flag, created_at, updated_at)
VALUES
(105, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-kcs4-nv027' AND status = 'DONE'), 27, 23, '2026-04-03', '2026-04-03', 'APPROVED', TRUE, 'NV027 đạt T4', 'tl_kcs01', 0, NOW(), NOW()),
(105, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-kcs4-nv028' AND status = 'PENDING'), 28, 24, '2026-04-11', NULL, 'PENDING', NULL, 'NV028 chờ HLV ngày mới', 'tl_kcs01', 0, NOW(), NOW()),
(105, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-kcs4-nv029' AND status = 'PENDING'), 29, 25, '2026-04-07', NULL, 'PENDING', NULL, 'NV029 chờ HLV', 'tl_kcs01', 0, NOW(), NOW()),
(105, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-kcs4-nv030' AND status = 'PENDING'), 30, 23, '2026-04-08', NULL, 'PENDING', NULL, 'NV030 chờ HLV', 'tl_kcs01', 0, NOW(), NOW());
...
INSERT INTO training_plans (id, form_code, title, start_date, end_date, team_id, line_id, status, current_version, note, min_training_per_day, max_training_per_day, created_by)
VALUES
(106, 'TP-TI-2026-004', 'Kế hoạch HLV T4/2026 - Tổ Tiện Ca Ngày', '2026-04-01', '2026-04-30', 1, 1, 'APPROVED', 1, 'Tổ Tiện T4 đã duyệt, đang thực hiện.', 1, 3, 'tl_tien01');
...
(106, 6,  'pend-mock-ti4-nv006', '2026-04-01', '2026-04-10', NULL,         'PENDING', 'NV006 chờ huấn luyện', 'tl_tien01', 0, NOW(), NOW());
...
-- Result 106 details: 5 batch_ids → 5 result details (2 APPROVED + 3 PENDING)
INSERT INTO training_result_details (training_result_id, training_plan_detail_id, employee_id, training_sample_id, planned_date, actual_date, status, is_pass, note, created_by, delete_flag, created_at, updated_at)
VALUES
-- NV001 batch → liên kết dòng DONE
...
-- NV002 batch → liên kết dòng DONE
(106, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-ti4-nv002' AND status = 'DONE'), 2, 2, '2026-04-03', '2026-04-03', 'APPROVED', TRUE, 'NV002 đạt T4 Tiện', 'tl_tien01', 0, NOW(), NOW()),
-- NV003 batch → liên kết dòng PENDING (ngày lên lịch lại)
...
-- NV004 batch → liên kết dòng PENDING
(106, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-ti4-nv004' AND status = 'PENDING'), 4, 4, '2026-04-09', NULL, 'PENDING', NULL, 'NV004 chờ HLV', 'tl_tien01', 0, NOW(), NOW()),
-- NV006 batch → liên kết dòng PENDING
(106, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-ti4-nv006' AND status = 'PENDING'), 6, 5, '2026-04-10', NULL, 'PENDING', NULL, 'NV006 chờ HLV', 'tl_tien01', 0, NOW(), NOW());
...
VALUES
(6, 'PL-TIEN-S1', 'Dòng Máy Bơm Chìm S-Series (Tiện)', 1, 'admin'),
...
VALUES
(21, 'BOM-S100', 'Bơm Chìm S100', 'Bơm chìm 1HP, ngập nước 100%, inox 304', 'admin'),
...
VALUES
-- Bơm Chìm S-Series
(21, 22, 55.0, 'admin'), (21, 23, 70.0, 'admin'), (21, 24, 40.0, 'admin'),
(22, 22, 58.0, 'admin'), (22, 23, 75.0, 'admin'), (22, 24, 42.0, 'admin'),
-- Van V-Series
(23, 25, 65.0, 'admin'), (23, 26, 80.0, 'admin'), (23, 27, 45.0, 'admin'),
(24, 25, 70.0, 'admin'), (24, 26, 85.0, 'admin'), (24, 27, 48.0, 'admin'),
-- Trục Khuỷu C-Series
(25, 28, 90.0, 'admin'), (25, 29, 120.0, 'admin'), (25, 30, 60.0, 'admin'),
(26, 28, 95.0, 'admin'), (26, 29, 130.0, 'admin'), (26, 30, 65.0, 'admin');
...
VALUES
-- Bơm Chìm
('DF041', 'Xước bề mặt trục bơm chìm inox', 22, '2025-05-10', 'DEFECTIVE_GOODS', 'Thay dao CBN mới', 'Soi đèn 100%', 'Dao mòn cắt inox', 'Bỏ qua soi đèn', 'Đài tiện', 'Nội bộ', 4, 'Lịch thay dao inox riêng', NULL, 'system'),
('DF042', 'Vỏ bơm chìm lệch tâm >0.03mm', 23, '2025-06-05', 'CLAIM', 'Kiểm đồ gá kẹp', 'Đo CMM trước lắp', 'Đồ gá mòn', 'Không đo CMM', 'Máy tiện CNC', 'KH Grundfos', 2, 'Cân chỉnh đồ gá hàng tuần', NULL, 'system'),
('DF043', 'Cánh bơm mất cân bằng >5g·mm', 24, '2025-07-12', 'DEFECTIVE_GOODS', 'Cân bằng lại trên máy', 'Kiểm cân bằng 100%', 'Đúc không đều', 'Bỏ qua kiểm', 'Trạm cân bằng', 'Nội bộ', 6, 'Kiểm cân bằng mỗi chi tiết', NULL, 'system'),
-- Van V-Series
('DF044', 'Mặt tựa van bị rỗ micro', 25, '2025-04-18', 'CLAIM', 'Tiện lại mặt tựa', 'Kiểm rò rỉ 100%', 'Phôi đúc có bọt khí', 'Không kiểm phôi', 'Mặt tựa van', 'KH Kitz', 3, 'Kiểm phôi trước gia công', NULL, 'system'),
('DF045', 'Ren trục van Tr28x5 bị sờn', 26, '2025-05-22', 'DEFECTIVE_GOODS', 'Thay dao tiện ren', 'Kiểm caliper ren', 'Dao ren mòn', 'Bỏ qua kiểm ren', 'Trạm tiện ren', 'Nội bộ', 5, 'Thay dao ren mỗi 100 chi tiết', NULL, 'system'),
('DF046', 'Đế van không phẳng >0.05mm', 26, '2025-06-10', 'DEFECTIVE_GOODS', 'Kiểm phẳng đồng hồ so', 'Đo 100% trước lắp', 'Kẹp lực quá mạnh', 'Không đo giữa ca', 'Đồ gá kẹp', 'Nội bộ', 8, 'SOP kiểm phẳng mỗi 10 chi tiết', NULL, 'system'),
-- Trục Khuỷu
('DF047', 'Cổ trục chính oval >0.01mm', 28, '2025-03-15', 'CLAIM', 'Tiện lại cổ trục', 'Đo 3 điểm panme', 'Kẹp phôi bị lệch tâm', 'Đo 1 điểm thay vì 3', 'Mâm cặp', 'KH Toyota', 1, 'Đo oval 3 điểm bắt buộc', NULL, 'system'),
('DF048', 'Độ nhám cổ biên Ra >1.0 sau tiện', 29, '2025-04-20', 'DEFECTIVE_GOODS', 'Mài superfinish lại', 'Đo nhám 100%', 'Bỏ qua superfinish', 'Đo nhám cuối ca', 'Trạm mài', 'Nội bộ', 3, 'Superfinish bắt buộc mỗi chi tiết', NULL, 'system'),
('DF049', 'Vết cháy mài trên cổ trục', 30, '2025-05-08', 'DEFECTIVE_GOODS', 'Giảm feed mài', 'Kiểm Barkhausen 100%', 'Feed quá nhanh gây cháy', 'Không kiểm Barkhausen', 'Máy mài CNC', 'Nội bộ', 2, 'Thêm kiểm Barkhausen vào SOP', NULL, 'system');
...
INSERT INTO training_plans (id, form_code, title, start_date, end_date, team_id, line_id, status, current_version, note, min_training_per_day, max_training_per_day, created_by)
VALUES
(107, 'TP-TI-2026-S01', 'Kế hoạch HLV T3/2026 - Dòng Bơm Chìm S-Series', '2026-03-01', '2026-03-31', 1, 6, 'APPROVED', 1, 'T3 Bơm Chìm đã duyệt.', 1, 3, 'tl_tien01');
...
INSERT INTO training_result_details (training_result_id, training_plan_detail_id, employee_id, training_sample_id, planned_date, actual_date, status, is_pass, note, created_by, delete_flag, created_at, updated_at)
VALUES
(107, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-s3-nv001' AND status = 'DONE'), 1, 1, '2026-03-05', '2026-03-05', 'APPROVED', TRUE, 'NV001 đạt Bơm Chìm', 'tl_tien01', 0, NOW(), NOW()),
(107, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-s3-nv002' AND status = 'PENDING'), 2, 2, '2026-03-13', NULL, 'PENDING', NULL, 'NV002 chờ HLV ngày mới', 'tl_tien01', 0, NOW(), NOW()),
(107, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-s3-nv003' AND status = 'DONE'), 3, 3, '2026-03-07', '2026-03-07', 'APPROVED', TRUE, 'NV003 đạt Bơm Chìm', 'tl_tien01', 0, NOW(), NOW()),
(107, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-s3-nv004' AND status = 'PENDING'), 4, 4, '2026-03-24', NULL, 'PENDING', NULL, 'NV004 chờ HLV lần 3', 'tl_tien01', 0, NOW(), NOW()),
(107, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-s3-nv006' AND status = 'PENDING'), 6, 5, '2026-03-12', NULL, 'PENDING', NULL, 'NV006 chờ HLV', 'tl_tien01', 0, NOW(), NOW());
...
INSERT INTO training_plans (id, form_code, title, start_date, end_date, team_id, line_id, status, current_version, note, min_training_per_day, max_training_per_day, created_by)
VALUES
(108, 'TP-TI-2026-V01', 'Kế hoạch HLV T4/2026 - Dòng Van V-Series', '2026-04-01', '2026-04-30', 1, 7, 'APPROVED', 1, 'T4 Van đã duyệt, đang thực hiện.', 1, 3, 'tl_tien01');

INSERT INTO training_plan_details (training_plan_id, employee_id, batch_id, target_month, planned_date, actual_date, status, note, created_by, delete_flag, created_at, updated_at)
VALUES
-- NV001: PENDING
(108, 1, 'pend-mock-v4-nv001', '2026-04-01', '2026-04-05', NULL,         'PENDING', 'NV001 chờ huấn luyện Van', 'tl_tien01', 0, NOW(), NOW()),
-- NV002: DONE
...
INSERT INTO training_result_details (training_result_id, training_plan_detail_id, employee_id, training_sample_id, planned_date, actual_date, status, is_pass, note, created_by, delete_flag, created_at, updated_at)
VALUES
(108, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-v4-nv001' AND status = 'PENDING'), 1, 1, '2026-04-05', NULL, 'PENDING', NULL, 'NV001 chờ HLV Van', 'tl_tien01', 0, NOW(), NOW()),
(108, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-v4-nv002' AND status = 'DONE'), 2, 2, '2026-04-03', '2026-04-03', 'APPROVED', TRUE, 'NV002 đạt Van T4', 'tl_tien01', 0, NOW(), NOW()),
(108, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-v4-nv003' AND status = 'DONE'), 3, 3, '2026-04-04', '2026-04-04', 'APPROVED', FALSE, 'NV003 trượt Van T4', 'tl_tien01', 0, NOW(), NOW()),
(108, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-v4-nv004' AND status = 'PENDING'), 4, 4, '2026-04-14', NULL, 'PENDING', NULL, 'NV004 chờ HLV ngày mới', 'tl_tien01', 0, NOW(), NOW()),
(108, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-v4-nv006' AND status = 'DONE'), 6, 5, '2026-04-06', '2026-04-06', 'APPROVED', TRUE, 'NV006 đạt Van T4', 'tl_tien01', 0, NOW(), NOW());
...
INSERT INTO training_plans (id, form_code, title, start_date, end_date, team_id, line_id, status, current_version, note, min_training_per_day, max_training_per_day, created_by)
VALUES
(109, 'TP-TI-2026-C01', 'Kế hoạch HLV T2/2026 - Dòng Trục Khuỷu C-Series', '2026-02-01', '2026-02-28', 1, 8, 'APPROVED', 1, 'T2 Trục Khuỷu đã duyệt.', 1, 3, 'tl_tien01');

INSERT INTO training_plan_details (training_plan_id, employee_id, batch_id, target_month, planned_date, actual_date, status, note, created_by, delete_flag, created_at, updated_at)
VALUES
-- NV001: DONE
(109, 1, 'pend-mock-c2-nv001', '2026-02-01', '2026-02-04', '2026-02-04', 'DONE', 'NV001 đã huấn luyện đạt', 'tl_tien01', 0, NOW(), NOW()),
-- NV002: DONE
...
INSERT INTO training_results (id, training_plan_id, title, form_code, year, team_id, line_id, status, current_version, note, created_by)
VALUES
(109, 109, 'Kết quả HLV T2/2026 – Dòng Trục Khuỷu', 'TR-RES-C-002', 2026, 1, 8, 'APPROVED', 1, 'T2 Trục Khuỷu đã duyệt hoàn tất.', 'tl_tien01');

INSERT INTO training_result_details (training_result_id, training_plan_detail_id, employee_id, training_sample_id, planned_date, actual_date, status, is_pass, note, created_by, delete_flag, created_at, updated_at)
VALUES
(109, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-c2-nv001' AND status = 'DONE'), 1, 1, '2026-02-04', '2026-02-04', 'APPROVED', TRUE, 'NV001 đạt Trục Khuỷu', 'tl_tien01', 0, NOW(), NOW()),
(109, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-c2-nv002' AND status = 'DONE'), 2, 2, '2026-02-05', '2026-02-05', 'APPROVED', TRUE, 'NV002 đạt Trục Khuỷu', 'tl_tien01', 0, NOW(), NOW()),
(109, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-c2-nv003' AND status = 'DONE'), 3, 3, '2026-02-06', '2026-02-06', 'APPROVED', TRUE, 'NV003 đạt Trục Khuỷu', 'tl_tien01', 0, NOW(), NOW()),
(109, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-c2-nv004' AND training_plan_id = 109 AND status = 'DONE'), 4, 4, '2026-02-17', '2026-02-17', 'APPROVED', FALSE, 'NV004 trượt Trục Khuỷu', 'tl_tien01', 0, NOW(), NOW()),
(109, (SELECT id FROM training_plan_details WHERE batch_id = 'pend-mock-c2-nv006' AND status = 'DONE'), 6, 5, '2026-02-07', '2026-02-07', 'APPROVED', TRUE, 'NV006 đạt Trục Khuỷu', 'tl_tien01', 0, NOW(), NOW());
