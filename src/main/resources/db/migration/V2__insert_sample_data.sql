...
VALUES (1, 'BOM-2024-X1', 'Bơm nước dân dụng X1', 'Công suất 1.5HP', 'ROLE_ADMIN'),
       ...
       (4, 'BOM-2024-X3', 'Bơm nước dân dụng X3', 'Công suất 2.0HP', 'admin'),
       (5, 'BOM-2024-X4', 'Bơm nước công nghiệp X4', 'Công suất 7.5HP', 'admin'),
       (6, 'MOT-2024-Y2', 'Động cơ xăng Y2', 'Động cơ 4 thì', 'admin'),
       (7, 'BOM-2024-X5', 'Bơm nước dân dụng X5', 'Công suất 3.0HP', 'admin'),
       (8, 'BOM-2024-X6', 'Bơm nước công nghiệp X6', 'Công suất 10.0HP', 'admin'),
       (9, 'MOT-2024-Y3', 'Động cơ xăng Y3', 'Động cơ 2 thì', 'admin'),
       (10, 'BOM-2024-X7', 'Bơm nước dân dụng X7', 'Công suất 1.2HP', 'admin'),
       (11, 'BOM-2024-X8', 'Bơm nước công nghiệp X8', 'Công suất 12.5HP', 'admin'),
       (12, 'MOT-2024-Y4', 'Động cơ xăng Y4', 'Động cơ 4 thì', 'admin'),
       (13, 'BOM-2024-X9', 'Bơm nước dân dụng X9', 'Công suất 1.0HP', 'admin'),
       (14, 'BOM-2024-X10', 'Bơm nước công nghiệp X10', 'Công suất 15.0HP', 'admin'),
       (15, 'MOT-2024-Y5', 'Động cơ xăng Y5', 'Động cơ 2 thì', 'admin'),
       (16, 'BOM-2024-X11', 'Bơm nước dân dụng X11', 'Công suất 2.5HP', 'admin'),
       (17, 'BOM-2024-X12', 'Bơm nước công nghiệp X12', 'Công suất 20.0HP', 'admin'),
       (18, 'MOT-2024-Y6', 'Động cơ xăng Y6', 'Động cơ 4 thì', 'admin'),
       (19, 'BOM-2024-X13', 'Bơm nước dân dụng X13', 'Công suất 3.5HP', 'admin'),
       (20, 'BOM-2024-X14', 'Bơm nước công nghiệp X14', 'Công suất 25.0HP', 'admin'),
       (21, 'MOT-2024-Y7', 'Động cơ xăng Y7', 'Động cơ 2 thì', 'admin'),
       (22, 'BOM-2024-X15', 'Bơm nước dân dụng X15', 'Công suất 4.0HP', 'admin'),
       (23, 'BOM-2024-X16', 'Bơm nước công nghiệp X16', 'Công suất 30.0HP', 'admin'),
       (24, 'MOT-2024-Y8', 'Động cơ xăng Y8', 'Động cơ 4 thì', 'admin'),
       (25, 'BOM-2024-X17', 'Bơm nước dân dụng X17', 'Công suất 4.5HP', 'admin'),
       (26, 'BOM-2024-X18', 'Bơm nước công nghiệp X18', 'Công suất 35.0HP', 'admin'),
       (27, 'MOT-2024-Y9', 'Động cơ xăng Y9', 'Động cơ 2 thì', 'admin'),
       (28, 'BOM-2024-X19', 'Bơm nước dân dụng X19', 'Công suất 5.0HP', 'admin'),
       (29, 'BOM-2024-X20', 'Bơm nước công nghiệp X20', 'Công suất 40.0HP', 'admin'),
       (30, 'MOT-2024-Y10', 'Động cơ xăng Y10', 'Động cơ 4 thì', 'admin');
...
VALUES ('DF001', 'Xước bề mặt trục', 1, '2023-09-01', 'DEFECTIVE_GOODS', 'Tăng tần suất kiểm tra dao',
        ...
        'Tiện', 'Khách hàng A', 10, 'Cần thay dao định kỳ', 'system'),
       ('DF002', 'Sai dung sai đường kính', 1, '2023-09-02', 'CLAIM', 'Hiệu chỉnh lại máy', 'Đào tạo lại QC',
        'Lọt lắp ráp', 'Sai offset', 'QC không kiểm 100%', 'Tiện', 'Khách hàng B', 5, 'Cần tăng cường kiểm tra', 'system'),
       ('DF003', 'Bavia chưa xử lý', 1, '2023-09-03', 'DEFECTIVE_GOODS', 'Bổ sung bước deburr vào quy trình',
        'Tạo checklist kiểm tra', 'Phát hiện QC', 'Thiếu bước deburr', 'Không có checklist', 'Hoàn thiện', 'Khách hàng A', 8, 'Bổ sung bước hoàn thiện', 'system'),
       ('DF004', 'Sai vị trí lỗ', 1, '2023-09-04', 'DEFECTIVE_GOODS', 'Sửa lại đồ gá', 'Thêm bước xác nhận đầu ca',
        'Máy lệch tâm', 'Đồ gá không cố định', 'Không xác nhận đầu ca', 'Khoan', 'Khách hàng C', 3, 'Kiểm tra jig đầu ca', 'system'),
       ('DF005', 'Biến dạng sau ép', 1, '2023-09-05', 'CLAIM', 'Hiệu chỉnh lực ép', 'Thêm bước kiểm tra lực ép',
        'Lọt công đoạn sau', 'Áp lực ép lớn', 'Không kiểm tra lực ép', 'Ép', 'Khách hàng B', 6, 'Cần kiểm tra lực ép', 'system'),

       ('DF006', 'Nứt bề mặt', 1, '2023-09-06', 'DEFECTIVE_GOODS', 'Hiệu chỉnh lò nhiệt', 'Giám sát nhiệt độ chặt chẽ',
        'Kiểm tra từ tính', 'Nhiệt luyện sai', 'Không kiểm soát nhiệt độ', 'Nhiệt luyện', 'Khách hàng D', 2, 'Kiểm soát nhiệt độ chặt chẽ', 'system'),
       ('DF007', 'Sai độ nhám', 1, '2023-09-07', 'STARTLED_CLAIM', 'Cập nhật lại thông số',
        ...
        'Khách hàng E', 12, 'Yêu cầu khách hàng đặc biệt', 'system'),
       ('DF008', 'Ren bị mòn', 1, '2023-09-08', 'DEFECTIVE_GOODS', 'Thay dao định kỳ', 'Quản lý tuổi thọ dao',
        'Dao ren mòn', 'Dao quá tuổi thọ', 'Không thay dao định kỳ', 'Tiện ren', 'Khách hàng A', 4, 'Nâng cấp dao', 'system'),
       ('DF009', 'Sai kích thước then', 1, '2023-09-09', 'DEFECTIVE_GOODS', 'Cập nhật lại bản vẽ',
        'Quy trình review bản vẽ', 'Sai bản vẽ', 'Cập nhật nhầm version', 'Không review bản vẽ', 'Phay', 'Khách hàng F', 7, 'Kiểm soát version bản vẽ', 'system'),
       ('DF010', 'Trầy xước nội bộ', 1, '2023-09-10', 'CLAIM', 'Sử dụng khay chuyên dụng', 'Kiểm tra packaging',
        'Vận chuyển nội bộ', 'Không có khay đựng', 'Không kiểm tra packaging', 'Vận chuyển', 'Khách hàng G', 9, 'Nâng cấp packaging', 'system'),
       ...
       ('DF011', 'Sai lực siết vít', 1, '2023-09-11', 'DEFECTIVE_GOODS', 'Hiệu chỉnh súng torque',
        ...
        'Khách hàng H', 5, 'Calibrate torque', 'system'),
       ('DF012', 'Sai vị trí rãnh', 1, '2023-09-12', 'DEFECTIVE_GOODS', 'Đào tạo lại cách set dao',
        'Kiểm tra first piece 100%', 'Lệch dao', 'Set dao sai', 'Không kiểm tra first piece', 'Phay', 'Khách hàng I', 6, 'Tăng cường đào tạo', 'system'),
       ('DF013', 'Sai chiều dài tổng', 1, '2023-09-13', 'CLAIM', 'Hiệu chỉnh offset', 'Kiểm tra 3 mẫu đầu', 'Lọt QC',
        'Offset sai', 'Không kiểm tra 3 mẫu đầu', 'Tiện', 'Khách hàng J', 11, 'Hiệu chỉnh offset ngay', 'system'),
       ('DF014', 'Rỗ bề mặt', 1, '2023-09-14', 'DEFECTIVE_GOODS', 'Kiểm tra vật liệu đầu vào',
        'Yêu cầu chứng chỉ vật liệu', 'Vật liệu lỗi', 'Nguyên liệu kém', 'Không kiểm incoming', 'Tiện', 'Khách hàng K', 3, 'Kiểm chứng chỉ vật liệu', 'system'),
       ('DF015', 'Cong vênh chi tiết', 1, '2023-09-15', 'CLAIM', 'Hiệu chỉnh quy trình nhiệt luyện',
        'Kiểm soát nhiệt độ chặt chẽ', 'Biến dạng', 'Nhiệt luyện sai', 'Không kiểm nhiệt độ', 'Nhiệt luyện', 'Khách hàng L', 8, 'Quay lại quy trình', 'system'),

       ('DF016', 'Tràn keo terminal', 2, '2023-10-01', 'DEFECTIVE_GOODS', 'Hiệu chỉnh máy bơm keo',
        'Kiểm tra đầu ca', 'Keo quá mức', 'Cài đặt sai', 'Không hiệu chỉnh đầu ca', 'Bơm keo', 'Khách hàng M', 4, 'Hiệu chỉnh máy bơm', 'system'),
       ('DF017', 'Thiếu lượng keo', 2, '2023-10-02', 'CLAIM', 'Bảo trì bơm định kỳ', 'Kiểm tra định lượng',
        'Test fail', 'Bơm không ổn định', 'Không kiểm tra định lượng', 'Bơm keo', 'Khách hàng N', 7, 'Bảo trì bơm', 'system'),
       ('DF018', 'Sai cực linh kiện', 2, '2023-10-03', 'DEFECTIVE_GOODS', 'Đào tạo lại nhân viên',
        'Thêm bước kiểm tra visual', 'Lắp ngược', 'Thiếu đào tạo', 'Không kiểm tra visual', 'Lắp ráp', 'Khách hàng O', 5, 'Đào tạo nhân viên', 'system'),
       ('DF019', 'Hở mối hàn', 2, '2023-10-04', 'CLAIM', 'Hiệu chỉnh nhiệt độ hàn', 'Tăng cường kiểm tra AOI',
        'AOI bỏ sót', 'Nhiệt hàn thấp', 'Không kiểm nhiệt độ', 'Hàn', 'Khách hàng P', 9, 'Hiệu chỉnh nhiệt hàn', 'system'),
       ('DF020', 'Cháy linh kiện', 2, '2023-10-05', 'CLAIM', 'Hiệu chỉnh máy test', 'Kiểm tra setup máy',
        'Sai điện áp', 'Cài đặt máy sai', 'Không kiểm setup', 'Test điện', 'Khách hàng Q', 2, 'Kiểm tra setup máy test', 'system'),

       ('DF021', 'Lệch vị trí bắt vít', 2, '2023-10-06', 'DEFECTIVE_GOODS', 'Sửa lại template', 'Kiểm tra jig đầu ca',
        'Template sai', 'Không cố định jig', 'Không kiểm tra đầu ca', 'Lắp ráp', 'Khách hàng R', 6, 'Sửa template', 'system'),
